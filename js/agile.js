(function() {
    tinymce.PluginManager.add('agilecrm_landing_pages_button', function( editor, url ) {
        editor.addButton( 'agilecrm_landing_pages_button', {
            text: 'Agile Forms',
            icon: false,
            onclick: function() {
            jQuery.ajax({
                ...
                editor.windowManager.open( {
                    ...
                    onsubmit: function( e ) {
                        editor.insertContent( '[agileform_landing_pages id="' + e.data.form+ '"]');
                    }
                });
                }
            });
